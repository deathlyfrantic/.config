...
local function set_links()
  local links = {
    ...
    TagbarVisibilityProtected = "GitSignsChange",
    TagbarVisibilityPublic = "GitSignsAdd",
    TagbarVisibilityPrivate = "GitSignsDelete",
    Whitespace = "Comment",
    healthSuccess = "GitSignsAdd",
    healthWarning = "GitSignsChange",
